...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--model_type', type=str, default='PDCRN')
    arg_parser.add_argument('--train_path', type=str, default='/media/hrishi/data/WORK/RESEARCH/2022/journal-2022/UDC/ds/Poled/train')
    arg_parser.add_argument('--test_path', type=str, default='/media/hrishi/data/WORK/RESEARCH/2022/journal-2022/UDC/ds/Poled/val')
    arg_parser.add_argument('--batch_size', type=int, default=1)
    arg_parser.add_argument('--epochs', type=int, default=1000)
    arg_parser.add_argument('--LR', type=int, default=1e-4)
    arg_parser.add_argument('--num_filters', type=int, default=8)
    arg_parser.add_argument('--dilation_rates', type=tuple, default=(3, 2, 1, 1, 1, 1))
    arg_parser.add_argument('--nPyramidFilters', type=int, default=8)
